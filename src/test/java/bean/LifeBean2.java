...
public class LifeBean2 extends BaseBean{
    ...
    @Xpath(xpath={"//android.widget.TextView[@text='京东众筹']"})
    @Description(description="京东众筹")
    ...
    @Xpath(xpath={"//android.widget.TextView[@text='白条']"})
    @Description(description="白条")
    ...
    @Xpath(xpath={"//android.widget.TextView[@text='智能记账']"})
    @Description(description="智能记账")
    ...
    @Xpath(xpath={"//android.widget.TextView[@text='一卡通']"})
    @Description(description="一卡通")
    ...
    @Xpath(xpath={"//android.widget.TextView[@text='保障保险']"})
    @Description(description="保障保险")
    ...
    @Xpath(xpath={"//android.widget.TextView[@text='违章代缴']"})
    @Description(description="违章代缴")
    ...
    @Xpath(xpath={"//android.widget.TextView[@text='转账']"})
    @Description(description="转账")
    public  PlainText  textViewTransAccount;
    ...
    @Xpath(xpath={"//android.widget.TextView[@text='电影票']"})
    @Description(description="电影票")
    ...
    @Xpath(xpath={"//android.widget.TextView[@text='预约挂号']"})
    @Description(description="预约挂号")
    ...
    @Xpath(xpath={"//android.widget.TextView[@text='水电煤']"})
    @Description(description="水电煤")
    ...
    @Xpath(xpath={"//android.widget.TextView[@text='语音识别']"})
    @Description(description="语音识别")
    ...
    public LifeBean2(AppiumDriver aDriver){super(aDriver);}
